...
export class ABS implements interfaces.Queryable, interfaces.RemoteRegistry {
    ...
    query(q: data.Query): Promise<message.DataMessage> {
        ...
        return this.retrieveData(q.getDataflow(),this.serviceURL, this.toGetDataQuery(q,this.options),{headers: {"Content-Type": this.mediaType, "SOAPAction": "http://stats.oecd.org/OECDStatWS/SDMX/GetCompactData"}});
    }
